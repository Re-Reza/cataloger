...
const AboutUs: FC<{ activeSlide: number; prevSlides: number }> = ({
  ...
  return (
    <>
      <SwiperSlide key={0} className="p-[3em]">
        ...
        <div className="flex gap-[4em] h-full">
          ...
          <div className="flex flex-col justify-between pb-[9%]">
            ...
            >
              <img src="/images/logo.png" width={110} height={110} alt="logo" />
            ...
            <motion.div
              variants={HorizontalSlideAppear("-5vw", 1.9, 0)}
              viewport={{ once: true }}
              initial="hidden"
              whileInView="visible"
          ...
          <div className="p-[2em] pt-[4em] flex flex-col items-center h-full">
            <div className="w-[60%] h-full">
              ...
              >
                ...
                محصولاتی را تولید می کند که عـــلاوه بر دوام و استحکام، به راحتی
                و ایمنی دانش آمــوزان نیز توجه ویژه ای دارد. تیم حرفــه ای ما با
                تخصص در زمینه نوســـازی مدارس، به روززسانی تجهیزات و ارائه
                راهکارهای خلاقانه، محیطی مناسب و الهام بخش برای دانش آموزان
                ایجاد می کند.
              </motion.p>
              <motion.div
                viewport={{ once: true }}
        ...
        <>
          <div className="grid grid-cols-2 gap-[22px] flex justify-center gap-5">
            ...
            <div>
              ...
              <motion.div
                viewport={{ once: true }}
                variants={HorizontalSlideAppear("-5vw", 1.9, 0.26)}
                initial="hidden"
                whileInView="visible"
              >
                <img
      ...
      <SwiperSlide key={3} className="p-[2em]">
        ...
        <div className="h-full flex flex-col justify-center">
          ...
          <div className="border-solid border-[darkBlue] p-[1.5em] text-justify text-[darkBlue] text-[1.3em] leading-[1.8] font-[600] border-l-[2.5px] border-t-[2.5px] border-b-[2.5px] border-r-0">
            <motion.p
              viewport={{ once: true }}
              variants={HorizontalSlideAppear("5vw", 1.9, 0.2)}
              initial="hidden"
              whileInView="visible"
            >
              در کارخانه مدرن تجهیز صنعت برین، بهره گیری از ربات های پـیشرفته
              جوشکار، گامی بلند در راستای افزایش بهره وری، یکنواختی کیفیت و کاهش
              زمان تولید برداشته ایم. این فناوری نوین، امکان اجرای اتصالات دقیق،
              مستحکم و یکدست را در ساهت محصولات فراهم می کند و باعث ارتقای سطـح
              کیفی تجهیزات آموزش و اداری تولیدی ما شده است. با تکیه بر این سیستم
              هوشمــند، سفارش های شما با دقت بالا و در سریع ترین زمان ممکن
              تولـید و تحـویل می گـردد.
            </motion.p>
          </div>
          <div className="grid grid-cols-3 grid-rows-[400px] gap-5 border-solid border-[darkBlue] p-[1.5em] border-l-0 border-t-0 border-b-[2.5px] border-r-[2.5px]">
            ...
            <motion.div
              viewport={{ once: true }}
              className="robot2Box"
              variants={HorizontalSlideAppear("-5vw", 1.9, 0.4)}
              initial="hidden"
              whileInView="visible"
            ></motion.div>
            <motion.div
              viewport={{ once: true }}
              className="robot3Box"
              variants={HorizontalSlideAppear("-5vw", 1.9, 0.8)}
              initial="hidden"
              whileInView="visible"
            ></motion.div>
          </div>
        ...
        <div>
          <div className="flex justify-end pr-[2.8em]">
            <div className="text-start w-full border-[darkBlue] p-[1.8em] border-solid border-l-0 border-t-[2px] border-b-[2px] border-r-[2px]">
              <motion.h2
                viewport={{ once: true }}
                variants={HorizontalSlideAppear("-5vw", 2, 0)}
                initial="hidden"
                whileInView="visible"
      ...
      <SwiperSlide key={5} className="p-[2em]"></SwiperSlide>
    </>
  );
};
